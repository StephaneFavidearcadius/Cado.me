...
<div class="max-w-5xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <a href="/c/<?= $slug ?>/gestion/parametres" class="bg-white border border-gray-100 p-6 hover:shadow-md transition group">
        ...
        <a href="/c/<?= $slug ?>/membres" class="bg-white border border-gray-100 p-6 hover:shadow-md transition group">
            <div class="w-12 h-12 bg-violet-100 flex items-center justify-center mb-4 group-hover:bg-violet-200 transition">
        ...
        <a href="/c/<?= $slug ?>/formations" class="bg-white border border-gray-100 p-6 hover:shadow-md transition group">
            <div class="w-12 h-12 bg-violet-100 flex items-center justify-center mb-4 group-hover:bg-violet-200 transition">
        ...
        <a href="/c/<?= $slug ?>/ressources" class="bg-white border border-gray-100 p-6 hover:shadow-md transition group">
            <div class="w-12 h-12 bg-violet-100 flex items-center justify-center mb-4 group-hover:bg-violet-200 transition">
        ...
        <a href="/c/<?= $slug ?>/evenements" class="bg-white border border-gray-100 p-6 hover:shadow-md transition group">
            <div class="w-12 h-12 bg-violet-100 flex items-center justify-center mb-4 group-hover:bg-violet-200 transition">
