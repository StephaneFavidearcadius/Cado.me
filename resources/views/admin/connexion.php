<h2 class="text-2xl font-bold text-white mb-2">Connexion administration</h2>
<p class="text-gray-400 mb-6 text-sm">Acces reserve aux super administrateurs.</p>

<form method="POST" action="/admin/connexion" class="space-y-5">
    <?= \App\Core\Csrf::field() ?>

    <!-- Email -->
    <div>
        <label for="email" class="block text-sm font-medium text-gray-300 mb-1.5">Adresse email</label>
        <div class="relative">
            ...
            <input type="email" id="email" name="email" required
                   ...
                   class="block w-full pl-11 pr-4 py-3 bg-gray-900 border border-gray-700 text-white text-sm focus:ring-2 focus:ring-violet-500 focus:border-transparent outline-none transition placeholder-gray-500"
                   placeholder="admin@cado.me">
        </div>
    </div>

    <!-- Mot de passe -->
    <div>
        <label for="mot_de_passe" class="block text-sm font-medium text-gray-300 mb-1.5">Mot de passe</label>
        <div class="relative" x-data="{ show: false }">
            ...
            <input :type="show ? 'text' : 'password'" id="mot_de_passe" name="mot_de_passe" required
                   class="block w-full pl-11 pr-12 py-3 bg-gray-900 border border-gray-700 text-white text-sm focus:ring-2 focus:ring-violet-500 focus:border-transparent outline-none transition placeholder-gray-500"
                   placeholder="••••••••">
            <button type="button" @click="show = !show"
                    class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-gray-500 hover:text-gray-300 transition">
